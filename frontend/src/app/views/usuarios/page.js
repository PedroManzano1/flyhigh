  ...
  return (
    <div className="p-10 bg-gray-100 min-h-screen font-sans text-zinc-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className={temPermissao('USUARIOS_WRITE') ? "lg:col-span-2" : "lg:col-span-3"}>
                ...
                {usuarios.map(u => (
                  <tr key={u.idUsuario} className="border-b-2 border-gray-100 hover:bg-yellow-50 transition-colors">
                    ...
                    <td className="p-4 flex justify-center gap-2">
                      {temPermissao('USUARIOS_WRITE') && (
                        <button onClick={() => router.push(`/views/usuarios/editar?id=${u.idUsuario}`)} className="p-2 border-2 border-zinc-900 hover:bg-zinc-900 hover:text-white transition-all shadow-[2px_2px_0px_0px_rgba(24,24,27,1)] active:shadow-none">✎</button>
                      )}
